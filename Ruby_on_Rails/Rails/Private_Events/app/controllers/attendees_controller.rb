class AttendeesController < ApplicationController
    ...
    def create
      ...
      enrollment = Attendee.new(event_id: event.id, user_id: params[:user_id])
    ...
    def destroy
      event = Event.find(params[:event_id])
      enrollment = Attendee.find(params[:id])
    ...
    def update
      @event = Event.find(params[:event_id])
      @enrollment = Attendee.find_by(event_id: params[:event_id], user_id: current_user.id)
